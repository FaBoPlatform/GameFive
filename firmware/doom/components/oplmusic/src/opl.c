...
/* Game Five: our prboom 2.5.0 i_sound.h predates this knob — declare it
 * directly (defined in main/i_sound.c). */
...
static void FillBuffer(int16_t *buffer, unsigned int nsamples)
{
    ...
    /* Game Five: Bit32s is long int on this toolchain; same width as int */
